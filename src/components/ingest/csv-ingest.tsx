...
export function CsvIngest({
  ...
  return (
    <div className="space-y-5">
      <ol className="grid grid-cols-3 rounded-xl border border-slate-200 bg-white p-2">
        {[
      ...
      <div className="grid gap-5 xl:grid-cols-[340px_1fr]">
        <div className="space-y-5">
          ...
          <Card className="p-5">
            ...
            <label
              htmlFor="csv-upload"
              className="mt-4 flex cursor-pointer flex-col items-center rounded-xl border border-dashed border-slate-300 bg-slate-50 px-4 py-8 text-center hover:border-blue-400 hover:bg-blue-50/40"
            >
              {loading ? (
